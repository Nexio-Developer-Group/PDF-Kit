...
class _CompressPdfPageState extends State<CompressPdfPage> {
  ...
  Future<void> _handleCompress(
    ...
    await Future.delayed(const Duration(milliseconds: 900)); // fake work
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Compressed "${p.basename(file.path)}" ($_levelLabel)'),
    ...
    return Consumer<SelectionProvider>(
      builder: (context, selection, _) {
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: Padding(
              padding: screenPadding.copyWith(top: 12),
              child: Column(
